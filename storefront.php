    ...
    <div id="newarrival" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <div class="card border shadow-sm h-100">
                            <a class="text-decoration-none text-dark" href="">
                                <img src="images/images (2).jpg" class="card-img-top" alt="Product"
                                    style="height: 300px; ">
                            ...
                            <button class="btn btn-danger w-100 mt-auto" type="submit">
                                <i class="bi bi-eye-fill"></i> Add to Cart
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border shadow-sm h-100">
                        <a class="text-decoration-none text-dark" href="">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="card-title" style="min-height: 48px;">Forza Horizon 5</div>
                        </a>
                ...
                <div class="card border shadow-sm h-100">
                    ...
                    <a class="text-decoration-none text-dark" href="">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="card-title" style="min-height: 48px;">Mario Kart World SWITCH 2</div>
                    </a>
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="card border shadow-sm h-100">
                ...
                <a class="text-decoration-none text-dark" href="">
                    <img src="images/pokemon legends z-a .jpg" class="card-img-top" alt="Product"
                        style="height: 300px; ">

                    <div class="card-body d-flex flex-column">

                        <div class="card-title" style="min-height: 48px;">POKEMON LEGENDS Z-A Switch 2</div>
                </a>
...
<div class="carousel-item">
    <div class="row g-4">
        <div class="col-lg-3 col-md-4 ">
            <div class="card border shadow-sm h-100">
                <a class="text-decoration-none text-dark" href="">
                    <img src="images/elden ring shadow of erd tree.jpg" class="card-img-top" alt="Product"
                        style="height: 300px; ">

                    <div class="card-body d-flex flex-column">

                        <div class="card-title" style="min-height: 48px;">Elden Ring Shadow of the Erdtree PS5</div>
                </a>
        ...
        <div class="card border shadow-sm h-100">
            <a class="text-decoration-none text-dark" href="">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="card-title" style="min-height: 48px;">Resident Evil 4 Remake PS5</div>
            </a>
...
<div class="col-lg-3 col-md-4">
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            <img src="images/Animal_Crossing_New_Horizons.jpg" class="card-img-top" alt="Product"
                style="height: 300px; ">
            <div class="card-body d-flex flex-column">

                <div class="card-title" style="min-height: 48px;">Animal Crossing: New Horizons Switch</div>
        </a>
    ...
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="card-title" style="min-height: 48px;">Marvel's Spider-Man 2 PS5</div>
        </a>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row g-4">
                    <div class="col-lg-3 col-md-4">
                        ...
                        <div class="card border shadow-sm h-100">
                            <a class="text-decoration-none text-dark" href="">
                                <img src="images/god of war ragnarok.jpg" class="card-img-top" alt="Product"
                                    style="height: 300px; ">
                ...
                <div class="col-lg-3 col-md-4 ">
                    <div class="card border shadow-sm h-100">
                        <a class="text-decoration-none text-dark" href="">
                            ...
                            <img src="images/horizon forbidden west.jpg" class="card-img-top" alt="Product"
                                style="height: 300px; ">

                            <div class="card-body d-flex flex-column">

                                <div class="card-title" style="min-height: 48px;">Horizon Forbidden West PS5</div>
                        </a>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="card border shadow-sm h-100">
                    ...
                    <a class="text-decoration-none text-dark" href="">
                        <img src="images/ratchet and clank rift apart.jpg" class="card-img-top" alt="Product"
                            style="height: 300px; ">

                        <div class="card-body d-flex flex-column">

                            <div class="card-title" style="min-height: 48px;">Ratchet & Clank: Rift Apart PS5</div>
                    </a>
            ...
            <div class="card border shadow-sm h-100">
                ...
                <a class="text-decoration-none text-dark" href="">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="card-title" style="min-height: 48px;">Demon's Souls Remake PS5</div>
                </a>
            ...
            <div class="card border shadow-sm h-100">
                <a class="text-decoration-none text-dark" href="">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="card-title" style="min-height: 48px;">Returnal PS5</div>
                </a>
        ...
        <div class="card border shadow-sm h-100">
            <a class="text-decoration-none text-dark" href="">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="card-title" style="min-height: 48px;">Ghost of Tsushima Director's Cut PS5</div>
            </a>
...
<div class="col-lg-3 col-md-4">
    ...
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            <img src="images/final fantasy xvi .jpg" class="card-img-top" alt="Product" style="height: 300px; ">
            <div class="card-body d-flex flex-column">

                <div class="card-title" style="min-height: 48px;">Final Fantasy XVI PS5</div>
        </a>
    ...
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="card-title" style="min-height: 48px;">Gran Turismo 7 PS5</div>
        </a>
        <p class="text-danger fw-bold mb-3">$59.00</p>
...
<button class="carousel-control-prev" type="button" data-bs-target="#ps5games" data-bs-slide="prev" style="width: 0px;">
    <span class="carousel-control-prev-icon bg-dark rounded-circle p-3"></span>
    ...
    <div id="ps4games" class="carousel slide" data-bs-ride="false">
        ...
        <div class="carousel-inner">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="card border shadow-sm h-100">
                            <a href="" class="text-decoration-none text-dark">
                                <img src="images/god of war 2018_.jpg" class="card-img-top" style="height: 300px;"
                                    alt="Product">
                                <div class="card-body d-flex flex-column">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="card border shadow-sm h-100">
                        <a href="" class="text-decoration-none text-dark">
                            ...
                            <div class="card-body d-flex flex-column">
                                <div class="card-title" style="min-height: 48px;">Marvelâ€™s Spider-Man PS4</div>
                        </a>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="card border shadow-sm h-100">
                    <a href="" class="text-decoration-none text-dark">
                        <img src="images/last of us part 2.jpg" class="card-img-top" style="height: 300px;"
                            alt="Product">
                        <div class="card-body d-flex flex-column">
        ...
        <div class="col-lg-3 col-md-4">
            <div class="card border shadow-sm h-100">
                <a href="" class="text-decoration-none text-dark">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="card-title" style="min-height: 48px;">Uncharted 4: A Thiefâ€™s End PS4</div>
                </a>
            ...
            <div class="carousel-item active">
                <div class="row g-4">
                    <div class="col-lg-3 col-md-4">
                        ...
                        <div class="card border shadow-sm h-100">
                            <a class="text-decoration-none text-dark" href="">
                                <img src="images/Halo infinite.jpg" class="card-img-top" alt="Product"
                                    style="height: 300px; ">
                ...
                <div class="col-lg-3 col-md-4 ">
                    <div class="card border shadow-sm h-100">
                        <a class="text-decoration-none text-dark" href="">
                            ...
                            <img src="images/FORZA MOTORSPORT.jpg" class="card-img-top" alt="Product"
                                style="height: 300px; ">

                            <div class="card-body d-flex flex-column">

                                <div class="card-title" style="min-height: 48px;">Forza Motorsport Xbox Series X</div>
                        </a>
                        <p class="text-danger fw-bold mb-3">$69.00</p>
                ...
                <div class="card border shadow-sm h-100">
                    ...
                    <a class="text-decoration-none text-dark" href="">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="card-title" style="min-height: 48px;">Starfield Xbox Series X</div>
                    </a>
            ...
            <div class="card border shadow-sm h-100">
                ...
                <a class="text-decoration-none text-dark" href="">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="card-title" style="min-height: 48px;">Gears 5 Xbox Series X</div>
                </a>
                <p class="text-danger fw-bold mb-3">$39.00</p>
...
<div class="carousel-item">
    <div class="row g-4">
        <div class="col-lg-3 col-md-4 ">
            <div class="card border shadow-sm h-100">
                <a class="text-decoration-none text-dark" href="">
                    <img src="images/MICROFOST FLIGHT SIMULATOR.jpg" class="card-img-top" alt="Product"
                        style="height: 300px; ">

                    <div class="card-body d-flex flex-column">

                        <div class="card-title" style="min-height: 48px;">Microsoft Flight Simulator Xbox Series X</div>
                </a>
        ...
        <div class="card border shadow-sm h-100">
            <a class="text-decoration-none text-dark" href="">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="card-title" style="min-height: 48px;">Fable Xbox Series X</div>
            </a>
    ...
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="card-title" style="min-height: 48px;">Sea of Thieves Xbox Series X</div>
        </a>
    ...
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="card-title" style="min-height: 48px;">Perfect Dark Xbox Series X</div>
        </a>
        <p class="text-danger fw-bold mb-3">$69.00</p>
            ...
            <div class="carousel-item active">
                <div class="row g-4">
                    <div class="col-lg-3 col-md-4">
                        ...
                        <div class="card border shadow-sm h-100">
                            <a class="text-decoration-none text-dark" href="">
                                <img src="images/LEGEND OF ZELDA.jpg" class="card-img-top" alt="Product"
                                    style="height: 300px; ">

                                <div class="card-body d-flex flex-column  ">
                                    <div class="card-title" style="min-height: 48px;">The Legend of Zelda: Tears of the
                                        Kingdom</div>
                            </a>
                            <p class="text-danger fw-bold mb-3">$69.00</p>
                ...
                <div class="col-lg-3 col-md-4 ">
                    <div class="card border shadow-sm h-100">
                        <a class="text-decoration-none text-dark" href="">
                            ...
                            <img src="images/SUPERMARIO ODYSSEY_.jpg" class="card-img-top" alt="Product"
                                style="height: 300px; ">

                            <div class="card-body d-flex flex-column">

                                <div class="card-title" style="min-height: 48px;">Super Mario Odyssey Switch</div>
                        </a>
                        <p class="text-danger fw-bold mb-3">$59.00</p>
                ...
                <div class="card border shadow-sm h-100">
                    ...
                    <a class="text-decoration-none text-dark" href="">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="card-title" style="min-height: 48px;">Splatoon 3 Switch</div>
                    </a>
            ...
            <div class="card border shadow-sm h-100">
                ...
                <a class="text-decoration-none text-dark" href="">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="card-title" style="min-height: 48px;">Metroid Dread Switch</div>
                </a>
                <p class="text-danger fw-bold mb-3">$59.00</p>
...
<div class="carousel-item">
    <div class="row g-4">
        <div class="col-lg-3 col-md-4 ">
            <div class="card border shadow-sm h-100">
                <a class="text-decoration-none text-dark" href="">
                    <img src="images/KIRBY THE FORGOTTEN LAND.jpg" class="card-img-top" alt="Product"
                        style="height: 300px; ">

                    <div class="card-body d-flex flex-column">

                        <div class="card-title" style="min-height: 48px;">Kirby and the Forgotten Land Switch</div>
                </a>
    ...
    <div class="col-lg-3 col-md-4 ">
        ...
        <div class="card border shadow-sm h-100">
            <a class="text-decoration-none text-dark" href="">
                <img src="images/SUPER SMASH BRO ULTIMATE SWITCH.jpg" class="card-img-top" alt="Product"
                    style="height: 300px; ">

                <div class="card-body d-flex flex-column">

                    <div class="card-title" style="min-height: 48px;">Super Smash Bros. Ultimate Switch</div>
            </a>
...
<div class="col-lg-3 col-md-4">
    ...
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            <img src="images/POKEMON SCARLETjpg.jpg" class="card-img-top" alt="Product" style="height: 300px; ">
            <div class="card-body d-flex flex-column">

                <div class="card-title" style="min-height: 48px;">PokÃ©mon Scarlet Switch</div>
        </a>
    ...
    <div class="card border shadow-sm h-100">
        <a class="text-decoration-none text-dark" href="">
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="card-title" style="min-height: 48px;">Luigi's Mansion 3 Switch</div>
        </a>
        <p class="text-danger fw-bold mb-3">$59.00</p>
