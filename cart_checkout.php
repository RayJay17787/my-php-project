        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="process_cart_order.php" method="POST">

                            <input type="hidden" name="grand_total" value="<?= $grand_total ?>">

                            <div class="mb-3">
                                <label class="form-label"><b>Full Name</b></label>
                                <input type="text" value="<?= $user['name'] ?>" class="form-control" name="customer_name" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label"><b>Email</b></label>
                                <input type="email" value="<?= $user['email'] ?>" class="form-control" name="customer_email" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label"><b>Contact</b></label>
                                <input value="<?= $user['phone'] ?>" type="tel" class="form-control" name="customer_contact" required>
                            </div>
